...
class _$AppSettingsStateImpl extends _AppSettingsState {
  const _$AppSettingsStateImpl({required this.appLanguage}) : super._();
  ...
  @override
  String toString() {
    return 'AppSettingsState._internal(appLanguage: $appLanguage)';
  }
...
abstract class _AppSettingsState extends AppSettingsState {
  const factory _AppSettingsState({required final AppLanguage appLanguage}) =
